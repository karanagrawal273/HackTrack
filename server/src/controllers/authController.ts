...
import { sendEmail } from '../utils/emailService'; // Assuming email service path
import { generateOTP } from '../utils/otpGenerator'; // We'll define this helper function next
...
const getSignedToken = (id: Types.ObjectId | string, userName: string): string => { 
...
export const forgotPassword = async (req: Request, res: Response) => {
  ...
  try {
    ...
    const resetToken = generateOTP(); // Using OTP for simplicity here
    ...
    await sendEmail(user.email, 'HackTrack Password Reset Request', emailBody);
